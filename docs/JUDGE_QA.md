...
## Why did the live experiment end INCONCLUSIVE even though treatment looked worse?

The control rate was 48.3% and treatment was 43.5%, but p = 0.1939 and the 95% confidence interval crossed zero. The evidence was not strong enough for the deterministic rollback rule. Returning INCONCLUSIVE is the correct behavior.
...
The project deliberately does not do that. Simulated resource IDs use the `demo_...` namespace, and the product states that they do not exist in the Razorpay dashboard.
